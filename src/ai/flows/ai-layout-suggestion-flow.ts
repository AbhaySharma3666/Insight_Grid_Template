...
Example for a 'simple report' with no side panel, two columns (60/40), and two rows (70/30):
\`\`\`json
{
  "canvas": {
    "aspectRatio": "16:9",
  ...
  "description": "A simple layout with a main content area for key metrics and a secondary area for details."
}
\`\`\`
`,
});
